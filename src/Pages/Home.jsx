                    ...
                    <div className="col-md-4">
                        <div className='p-3 bg-secondary rounded  shadow' style={{ color: "black" }}>
                            ...
                            <div className='d-flex justify-content-center gap-3 '>
                                <h4>Weight:</h4>
                                <input type="number" value={wei} onChange={(e) => Validate(e)} name='wei' style={{ height: "30px", width: "60px", backgroundColor: "whitesmoke", outlineStyle: "none" }} />
                                <h4>Kg</h4>
                            </div>
                            ...
                            <div className='d-flex justify-content-center gap-3 '>
                                <h4>Height:</h4>
                                <input type="number" value={hei} onChange={(e) => Validate(e)} name='hei' style={{ height: "30px", width: "60px" }} />
                                <h4>Cm</h4>
                            </div>

                            <button className='btn btn-primary w-100 mt-3' onClick={calculate}>Calculate</button>
                            <button className='btn btn-success w-100 mt-1' onClick={cancel}>Cancel</button>
